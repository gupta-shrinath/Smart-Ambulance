                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Dashboard / Profile / Update Details / Change Password </li>
                        </ol>
                    </div>
                </div>
            </div>
			...
			<div class="col-lg-6">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="add_building_details_code.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-7" ><input type="password" id="bname" name="bname" placeholder="Enter Old Password" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-7"><input type="password" id="bcemail" name="bpin" placeholder="Enter New Password" class="form-control"><small class="help-block form-text"></small></div>
                          </div>
						  
						  <div class="row form-group">
                            <div align =center class="col col-md-4"><label for="email-input" class=" form-control-label">Retype New Password</label></div>
					
                            <div class="col-12 col-md-7"><input type="password" id="email-input" name="bcname" placeholder="Retype New Password" class="form-control"><small class="help-block form-text"></small></div>
