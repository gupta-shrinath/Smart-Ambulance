...
<div id="right" style="background-color:#F9F9F9">
	...
	<div id="comments">
	<br/>
	<h1> ADD ANNOUNCEMENTS FOR CITIZENS</h1>
	<br/>
	<form method="post" action="broadcast_announcement.php">
	<p><label for="message">Announcement Title:</label></p>	
<input type="text" name="atitle" id="atitle" size="35" style="font-size: 20pt"><br>
<p><label for="message">Announcement:</label></p>	
						<textarea cols="50" rows="5" name="amessage" id="amessage"></textarea>

<br><input name="submit" type="submit" value="Submit Announcement">&nbsp;
    <input name="reset" type="reset" value="Reset Announcement"><br> <br>
</form>
