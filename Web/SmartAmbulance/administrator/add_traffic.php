                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Dashboard / User Details / Traffic Officer/ Add</li>
                        </ol>
                    </div>
                </div>
            </div>
				  ...
				  <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header">
                        <strong>Add Traffic Officer</strong> 
                      </div>
                      <div class="card-body card-block">
                        <form action="add_traffic_details_code.php" method="post" enctype="multipart/form-data" class="form-horizontal">
